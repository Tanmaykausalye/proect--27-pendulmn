...
function setup() {
    ...
    chain1 = new Chain(bob2.body,roof.body,-60, 0)
    chain2 = new Chain(bob3.body,roof.body,-20, 0)
    chain3 = new Chain(bob4.body,roof.body,20, 0)
    chain4 = new Chain(bob5.body,roof.body,60, 0)
